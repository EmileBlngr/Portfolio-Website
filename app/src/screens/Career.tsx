        ...
        <div className="timeline-container">
            <Timeline
                ...
                <TimelineItem>
                    ...
                    <TimelineContent>
                    <Typography component="span" sx={{fontSize: 17, fontWeight: 600}}>
                        <FormattedMessage id="career-rauzan-exp"/>
                    </Typography>
                    <Typography sx={{color: theme.palette.primary.contrastText, fontSize: 14, fontWeight: 600}}>
                        <FormattedMessage id="career-rauzan"/>
                    </Typography>
                    <Typography sx={{color: theme.palette.primary.dark, fontSize: 14}}>
                        <FormattedMessage id="career-rauzan-text"/>
                    </Typography>
                    </TimelineContent>
                </TimelineItem>
                ...
                <TimelineItem>
                    ...
                    <TimelineContent>
                    <Typography component="span" sx={{fontSize: 17, fontWeight: 600}}>
                        <FormattedMessage id="career-girondehabitat-exp"/>
                    </Typography>
                    <Typography sx={{color: theme.palette.primary.contrastText, fontSize: 14, fontWeight: 600}}>
                        <FormattedMessage id="career-girondehabitat"/>
                    </Typography>
                    <Typography sx={{color: theme.palette.primary.dark, fontSize: 14}}>
                        <FormattedMessage id="career-girondehabitat-text"/>
                    </Typography>
                    </TimelineContent>
                </TimelineItem>
            </Timeline>
